/*
* Filename: encrypt.xaml.cs
* Author:   Korneva Anastasiia
* Date:     23.02.2018
* This file contains functionality for encryption and decryption on a server-side
* Code base:https://www.schneier.com/code/blowfish.cs
*/
...
namespace client
{
    ...
    class encrypt
    {
        ...
        public void BlowFish(string hexKey)
        {
            randomSource = new RNGCryptoServiceProvider();
        ...
        public void BlowFish(byte[] cipherKey)
        {
            randomSource = new RNGCryptoServiceProvider();
            SetupKey(cipherKey);
        }
